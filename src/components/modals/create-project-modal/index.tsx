      ...
      <DialogContent className="bg-[#24262b]/90 text-white min-w-[45vw] p-0 overflow-hidden">
        ...
        <div className="p-2 pb-12 w-full h-full flex relative justify-center items-center gap-x-8">
          ...
          <div className=" relative w-[45%] h-[50vh] flex flex-col gap-y-3">
            ...
            <Input className="h-8 bg-[#343740] w-full rounded-md border border-white/20 px-3 py-1 text-sm shadow-sm focus-within:ring-white focus-visible:outline-none focus-visible:ring-1  pr-[72px]"></Input>
            <div className=" font-[300] text-[14px] text-[#676b74]">
              <span className="text-red-500 mr-1">*</span>项目描述
            </div>

            <Textarea className="h-8 bg-[#343740] w-full rounded-md border border-white/20 px-3 py-1 text-sm shadow-sm focus-within:ring-white focus-visible:outline-none focus-visible:ring-1  pr-[72px]"></Textarea>
            <Button className=" absolute bottom-10 w-full h-[3.8vh] bg-[#387BFF] hover:bg-blue-700 text-white">
              创建项目
            </Button>
          </div>
